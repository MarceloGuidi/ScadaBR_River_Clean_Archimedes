...
ESP_FlexyStepper stepper;//Criação da variável de tipo ESP_FlexyStepper "stepper".
...
unsigned int pulsos_por_volta = 20;//Criação da váriável de tipo 
//-----------------------------------------------------------------------------
...
//Chamada ao método 'begin' da função WiFi passando os valores "DESKTOP-F3R7F79 6901","87944>Cm" como parâmetros
  WiFi.begin("DESKTOP-F3R7F79 6901","87944>Cm");
